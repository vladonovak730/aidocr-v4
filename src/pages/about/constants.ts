export const VERSION_OPTIONS = [
  {
    title: 'We believe',
    description:
      'in a general artificial intelligence, designed to support its users in mission critical tasks within the AEC&O industry.',
  },
  {
    title: 'We act',
    description:
      'as a central information hub, seamlessly linking and interconnecting industry-specific data and tools.',
  },
  {
    title: 'We strive',
    description:
